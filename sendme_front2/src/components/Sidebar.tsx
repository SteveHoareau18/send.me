...
import { Menu, X, LogOut, FileText, Send } from "lucide-react";
                ...
                <div className="fixed right-0 top-0 h-full z-50 transition-all duration-300 ease-in-out">
                    ...
                    ${isOpen ? "w-64" : "w-20"} transition-all duration-300`}>
                            ...
                            <button
                                ...
                                className="mt-auto flex items-center gap-2 text-red-500 mb-4"
                            >
                    ...
                    <FileModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
            </>
    );
}
