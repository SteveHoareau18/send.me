        ...
        <div className="flex h-screen items-center justify-center bg-gradient-to-b from-blue-900 to-blue-500">
            <div className="w-[600px] bg-white p-10 rounded-xl shadow-lg flex flex-col">
                ...
                <div className="flex justify-between items-center">
                    <Link href="/signup">
                        <Button className="cursor-pointer bg-blue-800 text-white px-6 py-2 rounded-lg">Retour</Button>
                    </Link>
                    <Button onClick={handleCreateAccount}
                            className="cursor-pointer bg-blue-600 text-white px-6 py-2 rounded-lg">S&#39;enregistrer</Button>
                </div>
            </div>
        </div>
    );
